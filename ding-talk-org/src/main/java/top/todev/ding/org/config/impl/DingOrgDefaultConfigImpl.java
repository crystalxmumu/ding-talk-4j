package top.todev.ding.org.config.impl;
 ...
 */
@Data
public class DingOrgDefaultConfigImpl implements DingOrgConfigStorage, Serializable {

    private static final long serialVersionUID = 5461401128010913930L;
    /** 接口配置实例 */
    private DingOrgHostConfig hostConfig = null;
    /** 应用key */
